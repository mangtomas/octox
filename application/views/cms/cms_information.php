...
<?=isset($success) ? $success : null;?>
	...
	<form action="<?=base_url('cms/main/information')?>" method="POST" class="form-horizontal">
				...
				<div class="action-btn-container" style="margin-top:20px">
					<a href="javascript:history.back()" class="btn btn-info btn-small">Back</a> or <a href="<?=base_url('cms/main/information/modify')?>" >Edit information</a>
				</div>
				</div>
				<?php
					}else{
