...
<legend style="font: bold 26px 'arial';margin-bottom:10px"><i class="custom-icon-monitor" style="margin-top:-3px"></i>Role</legend>
	<form action="<?=base_url('cms/role/create')?>" method="POST" class="form-horizontal" id="role-form">
			...
			<fieldset>
				...
				<div class="action-btn-container">
					<input type="submit" class="btn btn-success btn-small" name="btn-submit" value="Create New" /> or <a href="javascript:history.back()">Cancel</a> <!---or <a href="#" class="to-hide" data-hide="email-container">Cancel</a>--->
				</div>
			</fieldset>
...
$(document).ready(function(){
	var validator = $("#role-form").validate({
		rules: {
			...
			role: {
				required: true,
				//remote: "<?=base_url('cms/role/create-new')?>"
			},
